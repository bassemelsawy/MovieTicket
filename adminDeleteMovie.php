    ...
    <section>
        <div class="container" style="margin-top: 150px">
            <div class="row">
                ...
                ?>
                <a href="deleteMovie.php" style="text-decoration: none"><button class="button" style="width: 250px; display: block; margin-left: auto; margin-right: auto; float: none; margin-bottom: 20px">Delete Another Movie</button></a>
            </div>
        </div>
    </section>
    <?php $con->close(); ?>
