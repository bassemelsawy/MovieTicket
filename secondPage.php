...
<body>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <img src="At-Eternity's-Gate.jpg" style="margin-bottom: 10px; margin-right: 20px; float: left">
                    <p id="movieRow1Page1" style="color: white; margin-top: 50px; font-family: monospace; font-size: 18px">DESCRIPTION FROM DATABASE</p>
                </div>
                <div class="col-md-12">
                    <img src="Halloween.jpg" style="margin-bottom: 10px; margin-right: 20px; float: left">
                    <p id="movieRow1Page1" style="color: white; margin-top: 50px; font-family: monospace; font-size: 18px">DESCRIPTION FROM DATABASE</p>
                </div>
                <div class="col-md-12">
                    <img src="Team-Khan.jpg" style="margin-bottom: 10px; margin-right: 20px; float: left">
                    <p id="movieRow1Page1" style="color: white; margin-top: 50px; font-family: monospace; font-size: 18px">DESCRIPTION FROM DATABASE</p>
                </div>
                <div class="col-md-12">
                    <img src="Creed-II.jpg" style="margin-bottom: 10px; margin-right: 20px; float: left">
                    <p id="movieRow1Page1" style="color: white; margin-top: 50px; font-family: monospace; font-size: 18px">DESCRIPTION FROM DATABASE</p>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="center">
            <div class="pagination">
                ...
                <a href="secondPage.php" class="active">2</a>
